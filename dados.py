...
#grafico AE maximo
plt.figure(figsize=(8, 5))
plt.hist(tabela_diaria['Max_Col5'], bins=10, range=(0, 1600), color='lightblue', edgecolor='black')
plt.xlim(-20, 1600) 
plt.ylim(0, 35)
plt.title('Histograma AE medio Diário', fontsize=14)
plt.xlabel('Valores de AE', fontsize=12)
...
#grafico AE minimo
plt.figure(figsize=(8, 5))
plt.hist(tabela_diaria['Min_Col5'], bins=10, range=(0, 1600), color='lightblue', edgecolor='black')
plt.xlim(-20, 1600) 
plt.ylim(0, 35)
